...
<section id="about-us">
  ...
  <div class="container p-1 p-sm-3">
    <div class="row">
      ...
      <div class="col-md-3">
        <img src="img/acercade" alt="nosotros" class="img-fluid">
        
      </div>

      <div class="col-9">
        <p>
          somos una empresa 100% Chiapaneca formada en las entrañas 
          de la Universidad Autónoma de Chiapas (UNACH). Nos enfocamos en 
          la venta de dulces regionales del estado de Chiapas 100% artesanales
