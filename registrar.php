          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Datos de registro</p>

                <form name="login" action="usuarios/insertarUsuarios.php" method="post">
                    ...
                    <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                    <input type="text" id="form3Example1c" class="form-control" 
                    placeholder="Apellido Paterno" name="Paterno">
                    </div>
                    ...
                    Estoy de acuerdo con los terminos y condiciones <a href="#!">Terminos del servicio</a>
                    </label>
                  </div>
             ...
             <img src="img/dulceregistro" class="img-fluid" alt="Sample image">
